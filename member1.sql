...
EXECUTE new_rider_account('rider1@aol.com', 'mi874G', 'Eliana Nown', 54);
  
/* Task 2: login to an account with email address and password. If both matches an existing account, print a message login is successful.  
If email does not match, print a message no such account. If email matches but password does not match, print wrong password.*/
